 ...
 */
final class Version20240725195916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course ADD category_id INT DEFAULT NULL, ADD thumbnail VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course DROP category_id, DROP thumbnail');
    }
}
